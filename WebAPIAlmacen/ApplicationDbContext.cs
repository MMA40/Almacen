...
namespace WebAPIAlmacen
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // modelBuilder.Entity<Familia>().HasKey(x => x.Id); no es necesario porque por convención de nombres sabe que Id es Primary Key
            ...
            //modelBuilder.Entity<DistribuidorProducto>().HasKey(x => new { x.Distribuidor, x.ProductoId });
